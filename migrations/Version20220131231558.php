...
final class Version20220131231558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE registration (id INT AUTO_INCREMENT NOT NULL, courseid_id INT NOT NULL, studentid_id INT NOT NULL, userid_id INT NOT NULL, registration_date DATE NOT NULL, INDEX IDX_62A8A7A7EAC3334A (courseid_id), INDEX IDX_62A8A7A71D429594 (studentid_id), INDEX IDX_62A8A7A758E0A285 (userid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE registration ADD CONSTRAINT FK_62A8A7A758E0A285 FOREIGN KEY (userid_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE email email VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
