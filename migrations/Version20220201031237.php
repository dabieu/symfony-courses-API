 ...
 */
final class Version20220201031237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE registration RENAME INDEX idx_62a8a7a758e0a285 TO IDX_62A8A7A7AEF269E6');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE registration RENAME INDEX idx_62a8a7a7aef269e6 TO IDX_62A8A7A758E0A285');
